...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/mdmediator/MainProject"
  ...
  s.source       = { :git => "https://github.com/mdmediator/MainProject.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MainProject/MainProject/**/*.{h,m,swift}"
